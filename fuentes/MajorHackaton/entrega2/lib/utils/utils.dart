...
class EventsCoord {
  static Map<DateTime, List<Event>> getEventsByEscuelaCiclo(String? escuela, String? ciclo) {
    if (escuela == null || ciclo == null) {
      ...
      )..addAll(EventosDatabase.getEventsByEscuelaCiclo(escuela,ciclo) as Map<DateTime, List<Event>>);
